...
// const TemporaryClientTable = ({ clientList, refreshClients }) => {
//   const navigate = useNavigate();
//   console.log('client list is ', clientList);
//   clientList = clientList.filter((client) => client?.clientType?.typeOfClient === 'Temporary');
...
//                       <TableCell>{entry.contactPerson[0].email}</TableCell>
//                       <TableCell>
//                         {entry.endDate
